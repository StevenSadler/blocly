...
public class ItemAdapter extends RecyclerView.Adapter<ItemAdapter.ItemAdapterViewHolder> {
    ...
    class ItemAdapterViewHolder extends RecyclerView.ViewHolder implements ImageLoadingListener, View.OnClickListener, CompoundButton.OnCheckedChangeListener {
        ...
        public ItemAdapterViewHolder(View itemView) {
            ...
            favoriteCheckbox = (CheckBox) itemView.findViewById(R.id.cb_rss_item_favoirite_star);
        ...
        public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
            if (archiveCheckbox.equals(compoundButton)) {
                Log.v(TAG, "Archive checkbox changed to: " + isChecked);
            } else {
                Log.v(TAG, "Favorite star changed to: " + isChecked);
            }
        }
    }
}
